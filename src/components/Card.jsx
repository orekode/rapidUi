    ...
    return (
      <Link to={'/exchange/product'}>
        <div className="relative group">
              <div className="w-full h-[300px] max-[550px]:h-[220px] max-[360px]:h-[170px] overflow-hidden relative border dark:border-[#262626] dark:bg-[#111] rounded-3xl  shadow-lg shadow-slate-200 dark:shadow-black">
