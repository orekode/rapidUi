...
const PageScroller = () => {
  ...
  console.log(position, window.scrollHeight);


  if(position > document.querySelector("body").scrollHeight / 2)
  return (
    <div onClick={() => window.scrollTo(0, 0)} className="fixed bottom-5 right-10 z-50 flex-col flex-center max-[700px]:hidden">
