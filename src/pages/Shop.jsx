      ...
      <div className="flex items-center gap-3 spacing">
          <div className="slide-item flex-grow w-[900px] h-[420px] max-[550px]:h-max bg-blue-500 text-white rounded-3xl grid grid-cols-12 p-12 max-[1000px]:p-9 max-[420px]:text-center max-[420px]:p-6">
            <div className="col-span-7 flex items-center max-[420px]:col-span-12">
              <div className="">
                <div className="title text-4xl max-[1000px]:text-3xl max-[550px]:text-xl">Join the fun : Campus shopping just keeps getting easier</div>
                <p className="content max-[1000px]:text-sm max-[550px]:text-xs my-4">Order a tech gadget and receive it "That Day Naa!!". Free daily deliveries on campus.</p>
            ...
            <div className="col-span-5 max-[420px]:col-span-12">
              <img src="/images/slide2.png" alt="" className="object-contain h-full w-full" />
            </div>
          </div>
          <div className="max-[890px]:hidden">
            ...
            <div className="slide-item w-[350px] h-[200px] bg-orange-500 text-white rounded-3xl grid grid-cols-12 p-4">
              <div className="col-span-7 flex items-center">
                <div className="">
                  <div className="title text-base">Payment after delivery – We trust you</div>
                  <p className="content my-2 text-xs">Order away – You only pay for your item after you've received it. It's as simple as that. Stay Rapid.</p>
                  <Sm>The call to action</Sm>
                </div>
              </div>
              <div className="col-span-5">
                <img src="/images/slide1.png" alt="" className="object-contain h-full w-full" />
              </div>
            </div>
          </div>
      </div>
